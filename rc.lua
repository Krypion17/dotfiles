...
-- Import my stuff
local mydock = require("theme/mydock")
local clock = require("theme/widgets/clock")
local taglist = require("theme/widgets/taglist")
...
beautiful.init("/home/krypion17/.config/awesome/theme/theme.lua")

-- This is used later as the default terminal and editor to run.
terminal = "kitty" or "x-terminal-emulator"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
		...
		bg_color = "#0c0f0f", accent_color = "#367f66", text_color = "#c8cdcc", icon_size = 40, icon_margin = 16,
                phrases = {"exit(0)", "Don't forget to be awesome.", "Bye!"}
            },
            mytextclock,
            s.mylayoutbox,
        },
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "l", function() logout_popup.launch{
        -- bg_color = "#261447", accent_color = "#ff4365", text_color = '#f706cf', icon_size = 40, icon_margin = 16, -- outrun
        bg_color = "#0b0c10", accent_color = "#1f2833", text_color = '#66fce1', -- dark
        -- bg_color = "#3B4252", accent_color = "#88C0D0", text_color = '#D8DEE9', -- nord
        -- bg_color = "#282a36", accent_color = "#ff79c6", phrases = {}, -- dracula, no phrase
...
require("theme.titlebar.titlebar")
...
awful.spawn.with_shell("picom --config=/home/krypion17/.config/picom/picom.conf")
